...
public final class FpBankConnection implements BankConnection {
    ...
    public BankConnection edit(final EditBankConnectionParameters parameters) {
        return new FpBankConnection(
            ...
            new JSONObject(
                this.endpoint.patch(
                    "%s/%d".formatted(this.url, this.id()),
                    this.token,
                    parameters
                )
            ),
    ...
    public BankConnection connectInterface(final ConnectInterfaceParameters parameters) {
        return new FpBankConnection(
            ...
            new JSONObject(
                this.endpoint.post(
                    "%s/%s".formatted(this.url, "connectInterface"),
                    this.token,
    ...
    public void removeInterface(final BankingInterface bankingInterface) {
        this.endpoint.post(
            "%s/%s".formatted(this.url, "removeInterface"),
            this.token,
            () -> new JSONObject()
    ...
    @Override
    public void delete() {
        this.endpoint.delete("%s/%d".formatted(this.url, this.id()), this.token);
    }
}
